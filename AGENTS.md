...
- **生产环境 IP 只信 `request.eo.clientIp`**，不回退可伪造的代理头；`getClientIp` 与响应工具函数在 `index.js`/`[[default]].js` 双份内联，改一必改二。[契约](.agents/notes/implemented/architecture/2026-08-14-client-ip-acquisition-contract.md)
